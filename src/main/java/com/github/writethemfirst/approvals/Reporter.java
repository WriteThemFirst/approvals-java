...
public interface Reporter {
     ...
     *
     * @param files the {@link ApprovedAndReceived} which holds the *approved* file (which contains the data reviewed and
     ...
     */
    void mismatch(final ApprovedAndReceived files);

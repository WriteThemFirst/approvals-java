...
<p align='center'>
    ...
    <a href='https://github.com/WriteThemFirst/approvals-java/tree/v0.6.0'>
        <img src='https://img.shields.io/github/commits-since/WriteThemFirst/approvals-java/v0.6.0.svg' />
    </a>
...
```groovy
testCompile 'com.github.writethemfirst:approvals-java:0.6.0'
```
...
```scala
libraryDependencies += "com.github.writethemfirst" % "approvals-java" % "0.6.0"
```

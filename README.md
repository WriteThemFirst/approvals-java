...
<p align='center'>
    ...
    <a href='https://github.com/WriteThemFirst/approvals-java/tree/vv0.13.1'>
        <img src='https://img.shields.io/github/commits-since/WriteThemFirst/approvals-java/vv0.13.1.svg' />
    </a>
...
```groovy
testCompile 'com.github.writethemfirst:approvals-java:v0.13.1'
```
...
```scala
libraryDependencies += "com.github.writethemfirst" % "approvals-java" % "v0.13.1"
```

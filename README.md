...
<p align='center'>
    ...
    <a href='https://github.com/WriteThemFirst/approvals-java/tree/v0.5.3'>
        <img src='https://img.shields.io/github/commits-since/WriteThemFirst/approvals-java/v0.5.3.svg' />
    </a>
...
```groovy
testCompile 'com.github.writethemfirst:approvals-java:0.5.3'
```
...
```scala
libraryDependencies += "com.github.writethemfirst" % "approvals-java" % "0.5.3"
```

...
<p align='center'>
    ...
    <a href='https://github.com/WriteThemFirst/approvals-java/tree/v0.7.2'>
        <img src='https://img.shields.io/github/commits-since/WriteThemFirst/approvals-java/v0.7.2.svg' />
    </a>
...
```groovy
testCompile 'com.github.writethemfirst:approvals-java:0.7.2'
```
...
```scala
libraryDependencies += "com.github.writethemfirst" % "approvals-java" % "0.7.2"
```
